...
(function() {;
  ...
  // TRANSFORMS
  var TRANSF_mouseSpaceToHUDSpace = new THREE.Matrix4();
  var TRANSF_cameraSpaceToHUDSpace = new THREE.Matrix4();
  ...
  function init() {
    // threeTest
    let threeTest = document.getElementById('threeTest');

    updateComputedGeometry();

    camera = new THREE.PerspectiveCamera(
      70,             // fov
      threeTest.clientWidth / threeTest.clientHeight, // aspect
      1,              // near
      1000            // far
    );
    camera.position.x = 0;
    ...
    _textureLoader.load("images/circle.png", createCircleSprite);
    _textureLoader.load("images/star.png", createStarSprite);
    _textureLoader.load("images/redballon.png", createRedballonSprite);

    // renderer
    renderer = new THREE.WebGLRenderer();
    renderer.setPixelRatio(threeTest.devicePixelRatio);
    renderer.setSize(threeTest.clientWidth, threeTest.clientHeight);
    renderer.autoClear = false; // To allow render overlay on top of sprited sphere

    canvas = threeTest.appendChild(renderer.domElement);
  ...
  function getHUDVectorFromWorldVector(vector, camera) {
    ...
    HUDVector.applyMatrix4(TRANSF_cameraSpaceToHUDSpace);
